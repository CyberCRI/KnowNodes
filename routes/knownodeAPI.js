...
exports.show = function (req, res) {
    ...
    DB.Edge.all({where:{__ID__:id}}, callBack(res));
};

// POST
exports.create = function (req, res) {
    DB.User.findOne({ where: { '__ID__': '10cc7ba9-c651-4e4c-9eb6-a1143397ceae'}}, function(err, user){
        if(err)
        {
            res.json(err);
        }
        else {
        user.Posts.create(req.body, callBack(res));
        /*
...
exports.update = function (req, res) {
    ...
    DB.Post.all({where: {__ID__: id}}, callBack(res));
};
