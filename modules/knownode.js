/*** Generated by streamline 0.4.11 (callbacks) - DO NOT EDIT ***/ var __rt=require('streamline/lib/callbacks/runtime').runtime(__filename),__func=__rt.__func,__cb=__rt.__cb; (function() {
  ...
  module.exports = Knownode = (function(_super) {
    ...
    Knownode.prototype.getKnownodeByUrl = function Knownode_prototype_getKnownodeByUrl__11(url, _) { var knownode, params, __this = this; var __frame = { name: "Knownode_prototype_getKnownodeByUrl__11", line: 164 }; return __func(_, this, arguments, Knownode_prototype_getKnownodeByUrl__11, 1, __frame, function __$Knownode_prototype_getKnownodeByUrl__11() {

        __this.logger.logDebug(__this.currentModule, ("getKnownodeByUrl " + url));
        params = {
          where: {
            url: url } };
    ...
    Knownode.prototype.destroy = function Knownode_prototype_destroy__12(id, _) { var kn_File, knownode, params, query, __this = this; var __frame = { name: "Knownode_prototype_destroy__12", line: 177 }; return __func(_, this, arguments, Knownode_prototype_destroy__12, 1, __frame, function __$Knownode_prototype_destroy__12() {
        ...
        return __this.neo4jDB.query(query, params, __cb(_, __frame, 9, 17, function ___(__0, __1) { knownode = __1;
          ...
          return kn_File.deleteFile(knownode.fileId, __cb(_, __frame, 12, 6, function __$Knownode_prototype_destroy__12() {
