...
AbstractClass.hasMany = function hasMany(anotherClass, params) {
    /*
    if(this.schema.adapter.hasMany)
    {
        this.schema.adapter.hasMany(this, anotherClass, params);
        return;
    }
    */
...
AbstractClass.belongsTo = function (anotherClass, params) {
    if(this.schema.adapter.belongsTo)
    {
        this.schema.adapter.belongsTo(this, anotherClass, params);
        return;
    }
