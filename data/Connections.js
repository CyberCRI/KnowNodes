/*** Generated by streamline 0.6.0 (callbacks) - DO NOT EDIT ***/ var __rt=require('streamline/lib/callbacks/runtime').runtime(__filename),__func=__rt.__func,__cb=__rt.__cb; (function() {
  var Connection, ConnectionValidator, Connections, Error, OwnedEntities, Type, _ref, __hasProp = {
  ...
  module.exports = Connections = (function(_super) {
    ...
    Connections.create = function Connections_create__1(startResource, endResource, creator, data, _) { var connection, __this = this; var __frame = { name: "Connections_create__1", line: 32 }; return __func(_, this, arguments, Connections_create__1, 4, __frame, function __$Connections_create__1() {
    ...
    Connections.latestTriplets = function Connections_latestTriplets__2(user, _) { var aWeekAgo, cypherQuery, item, luceneQuery, nodes, now, results, toPush, userNodeId, _i, _len, _ref1, _ref2, __this = this; var __frame = { name: "Connections_latestTriplets__2", line: 43 }; return __func(_, this, arguments, Connections_latestTriplets__2, 1, __frame, function __$Connections_latestTriplets__2() {
    ...
    Connections.hottestTriplets = function Connections_hottestTriplets__3(user, _) { var aMonthAgo, cypherQuery, hot, hotness, item, luceneQuery, nodes, noveltyInDays, now, results, toPush, userNodeId, _i, _len, _ref1, _ref2, __this = this; var __frame = { name: "Connections_hottestTriplets__3", line: 76 }; return __func(_, this, arguments, Connections_hottestTriplets__3, 1, __frame, function __$Connections_hottestTriplets__3() {
