...
(function() {
  var baseController, bot, client, commentModule, getFirstItem, getFirstParagraph, getInternalLinks, knownodeModule, makeCallbackJoin, makeLinksToUrls, makeWikipediaUrl, relationModule;
  ...
  getFirstParagraph = function(title, callback) {
    ...
    return client.api.call(params, function(data) {
      var match, regex;
